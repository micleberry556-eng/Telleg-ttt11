  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        chat: {
          bg: "hsl(var(--chat-bg))", hover: "hsl(var(--chat-hover))",
          active: "hsl(var(--chat-active))", "active-foreground": "hsl(var(--chat-active-foreground))",
        },
        online: "hsl(var(--online))",
        admin: { accent: "hsl(var(--admin-accent))", "accent-foreground": "hsl(var(--admin-accent-foreground))" },
